...
class StoragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create storage" do
    assert_difference('Storage.count') do
      post storages_url, params: { storage: { food_id: @storage.food_id, remark: @storage.remark, user_id: @storage.user_id } }
    end
  ...
  test "should update storage" do
    patch storage_url(@storage), params: { storage: { food_id: @storage.food_id, remark: @storage.remark, user_id: @storage.user_id } }
